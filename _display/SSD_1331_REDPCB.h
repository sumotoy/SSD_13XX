...
/*=========================================================================================
	...
	---------------------------------------------------------------------------------------
	Display Type: SSD_1331 RED PCB 0.96" color oled
===========================================================================================*/
	/* Physical display size
	*/
	static const int16_t	SSD_WIDTH				=	96;
	static const int16_t	SSD_HEIGHT 				=	64;
	/* Hardware timings (If you see garbage on screen try increase those)   */
	static const int	 	CMD_DLY_LINE			= 	400;//SSD1351 400
	static const int	 	CMD_DLY_FILL			= 	800;//SSD1351 800
	static const int	 	CMD_DLY_MIN				= 	10;//this is the min delay (nicrosec) for this device
